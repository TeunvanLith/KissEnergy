...
<div class="w-full bg-black">
	<div class="max-w-[1400px] mx-auto">
		...
		<div class="flex text-white pt-4 px-6">
			<button 
				class="flex items-center gap-2 px-4 py-2 pb-8 rounded-t-lg border-b-8 border-yellow-500 transition-all duration-200 {$activeSection === 'particulieren' ? 'bg-yellow-400 text-black' : 'hover:bg-gray-800'}"
